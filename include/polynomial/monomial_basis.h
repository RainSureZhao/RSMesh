...
#ifndef RSMESH_MONOMIAL_BASIS_H
#define RSMESH_MONOMIAL_BASIS_H

#include "common/macros.h"
#include "geometry/point3d.h"
#include "polynomial_basic_base.h"
#include "types.h"
#include "Eigen/Core"
...
namespace rsmesh::polynomial {
    ...
    public:
        explicit monomial_basis(int dimension, int degree) : polynomial_basis_base(dimension, degree) {
            RSMESH_ASSERT(degree >= 0 and degree <= 2);
        }
